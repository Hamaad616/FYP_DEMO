                            ...
                            <div class="card-body">
                                ...
                                <form class="form" method="post" action="{{url('purchase')}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="pending_amount" placeholder="Pending Amount" id="product-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="cost"  placeholder="Cost" id="product-input">
                                        </div>
                                    </div>
                                   <div class="form-group row">
                                        <label for="example-search-input" class="col-2 col-form-label"> Profit</label>
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="profit" placeholder="Profit" id="product-input">
                                        </div>
                                    </div>
                                    <div class="form-group row">
