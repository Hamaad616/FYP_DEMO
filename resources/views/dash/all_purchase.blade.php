                                    ...
                                    <table id="example24" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$purchase->per_item_price}}</td>
                                                <td>{{$purchase->noproducts}}</td>
                                                
                                                <td>
                                                    <a href="{{route('purchases.edit', $purchase->id)}}" class="text-inverse p-r-10" data-toggle="tooltip" title="Edit"><i class="ti-marker-alt"></i></a>
                                                    <form method="post" style="display: inline-block;" action="{{route('purchases.destroy', $purchase->id)}}">
