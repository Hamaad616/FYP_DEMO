              ...
              <div class="mainmenu-area text-center hidden-sm hidden-xs">
                        <nav>
                            <div class="mainmenu">
                                ...
                                <li><a href="{{url('become_a_seller')}}" data-toggle="modal" data-target="#myModal">Become a seller</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                                                    ...
                                                    <div class="single-product">
                                                        <div class="single-product-item clearfix">
                                                            <div class="single-product-img clearfix">
                                                                ...
                                                                <div class="wish-icon-hover text-center clearfix " style="padding-left: 30%;">
                                                                    <div class="hover-text">
                                                                        <p class="hidden-md"> </p>
                                                                        <ul>
                                                            ...
                                                            <div class="single-product-info clearfix">
                                                                ...
                                                                <div style="text-align: center; font-size: 16px;">
                                                                    <span class="new-price"><strong>
                                                                            <a href="{{url('customer_product_detail')}}/{{$product->id}}">{{$product->product_name}}</a>
                                                                        </strong><br></span>
                                                                    <span>{{$product->get_category['article']}}-{{$product->id}}</span>
                                                                </div>
