        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" style="font-size: x-large ;">ATTENTION</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-product">
                                                            ...
                                                            <div class="product-info">
                                                                ...
                                                                <a style="margin-left:13px" href="{{url('customer_product_detail')}}/{{$product->id}}" class="see-all">See all features</a>
