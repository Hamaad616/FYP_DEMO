        ...
        <div>
            ...
            @endif
                ...
                @if (Cart::count() > 0)
                    ...
                    <h1 class="font-weight-bold" style="font-size: large; font-family: Montserrat,serif">{{Cart::count()}} item(s) in Shopping Cart</h1>
                        ...
                        @foreach (Cart::content() as $item)
                            <div class="cart-table-row">
                                <div class="cart-table-row-left">
                                    <a href="{{ url('product_detail', $item->model->id) }}"><img class="cart-table-img" src="{{ asset('uploads/' .$item->model->slug.'/'. $item->model->product_image) }}"  alt="item"></a>
                                    <div class="cart-item-details">
                                        <div class="cart-table-item">  <a style="color: #0a0a0a" href="{{ url('product_detail', $item->model->id) }}">{{ $item->name }}</a></div>
                    ...
                    @if (! session()->has('coupon'))
                        ...
                        <a href="#" class="have-code text-left">Have a Code?</a>
                        ...
                        <div class="cart-totals-right">
                            <div>Subtotal <br>
                                @if (session()->has('coupon'))
                                    ...
                                    <form action="{{ url('coupon.destroy') }}" method="POST" style="display:block">
                                        {{ csrf_field() }}
                                        {{ method_field('delete') }}
                        ...
                        @foreach (Cart::instance('saveForLater')->content() as $item)
                            <div class="cart-table-row">
                                <div class="cart-table-row-left">
                                    ...
                                    <div class="cart-item-details">
                                        <div class="cart-table-item"><a style="color: #0a0a0a; text-decoration: none;" href="{{ url('product_detail', $item->model->id) }}">{{ $item->name }}</a></div>
                                        <div class="cart-table-description">{{ $item->model->description }}</div>
                                    </div>
                                </div>
                                <div class="cart-table-row-right">
